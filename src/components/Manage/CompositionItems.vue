<template>
  <div class="border border-gray-200 p-3 mb-4 rounded body">
              <div v-show="!ShowForm">
              ...
              <div v-show="ShowForm">
                <div class="text-white text-center font-bold p-4 mb-4" v-show="show_alert"
                :class="alert_variant">
                  {{alert_message}}
                </div>
                ...
                <ErrorMessage class="text-red-600" name="genre"/>
                  ...
                  :disabled="in_submission" @click="ShowForm = false">
                    Go Back
                  </button>
                </vee-form>
              </div>
